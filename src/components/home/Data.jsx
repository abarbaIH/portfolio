...
const Data = () => {
    ...
    return (
        <div className="home__data">
            <h1 className="home__title">Álvaro Barba
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                "¡Hola! Mi nombre es Álvaro Barba y recientemente he finalizado exitosamente un bootcamp de desarrollo web en Ironhack. Durante los últimos 10 años, he estado trabajando en el sector logístico, donde he tenido la oportunidad de desempeñarme en diversas áreas de la cadena de suministro. Esta experiencia me ha brindado un amplio conocimiento en procedimientos y he desarrollado habilidades sólidas en organización, adaptabilidad al cambio y trabajo en equipo.
                <br />
                Ahora, mi meta es comenzar una nueva etapa como desarrollador web, con el propósito de aplicar todo lo que he aprendido hasta ahora y, por supuesto, seguir aprendiendo y creciendo en este apasionante campo. Estoy entusiasmado por la posibilidad de formar parte de un equipo en el que pueda contribuir con mis conocimientos adquiridos, al tiempo que continúo desarrollándome profesionalmente en el ámbito del desarrollo web."
